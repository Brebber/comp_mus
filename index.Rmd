...
As visible in the confusion matrix this algorithm performs fairly well, but it is most definitely biased as the dataset is quite small. I have decided to run three little experiments with the KNN, to see if three different genres would be considered Metal or Rock. More on the experiments on the following pages.

### Is Glam Metal Really Metal? (according to the KNN)
```{=html}
<iframe style="border-radius:20px"
src="https://open.spotify.com/playlist/1DAC3LdsyquzqziE5Ucja1?si=0e04ea6b51e140af" width="100%" height="152" frameBorder="0" allowtransparency="true" allow="encrypted-media" data-external="1"></iframe>
```
#### Introduction
The first genre on the border between Rock and Metal is Glam Metal or Hair Metal. This was a popular subgenre of Metal in the '80s, which (un)fortunately basically went extinct because of the genre on the next page. For this experiment I created a 10 song playlist which is meant to provide a good but brief overview of the genre, and functions as our first test subject. I expect most of these songs to be classed as Rock music, because I think the genre is closer to Hard Rock than it is to Metal, because it is more upbeat and happy than the Metal in my corpus playlist and because I only picked 10 songs.

#### Results
This needs a visual of some sort.\
Metal: Both Mötley Crüe songs, 'Welcome To The Jungle', 'Pour Some Sugar On Me'\
Rock: Rest\ 
Metal Ratio: 4/10\

#### Conclusion
As expected, Glam Metal does not score very high, although higher than I expected honestly.

### The Genre that 'Killed' Glam 
```{=html}
<iframe style="border-radius:20px"
src="https://open.spotify.com/playlist/1rWZDin7auum63WpMfva5j?si=eef274215e7e46d9" width="100%" height="152" frameBorder="0" allowtransparency="true" allow="encrypted-media" data-external="1"></iframe>
```
#### Introduction
The second genre I wanted to take a look at is Grunge, the early '90s Alternative Rock lovechild between Punk-Rock and Metal. For this playlist I added 5 heavy songs and 5 a bit slower songs, both are common in this genre, so my guess would be that the first 5 songs are classed as Metal and the last 5 are classed as Rock. 

#### Results
This needs a visual of some sort.\
Metal: 'Rusty Cage', 'Heart-Shaped Box', 'Rooster'.

#### Conclusion
Interestingly enough the algorithm did not classify the songs as I expected. Grunge is slightly less of a Metal subgenre than Glam Metal according to the KNN.

### Nu-Metal
```{=html}
<iframe style="border-radius:20px"
src="https://open.spotify.com/playlist/1OVisrN9f3HCJ92DSnRAbd?si=568aff9ac0b54662" width="100%" height="152" frameBorder="0" allowtransparency="true" allow="encrypted-media" data-external="1"></iframe>
```
#### Introduction
The third genre I chose is Nu-Metal, which confusingly enough is not considered to be 'real Metal' by the majority of the Metal community. That probably has more to do with the quality of some of the music in the genre than the actual sound of it. For this playlist I picked 10 songs that I feel capture the sound of the genre pretty well. I predict that the KNN will class most of the songs in this playlist as Metal.

#### Results
Slipnot and Korn are Metal, rest isn't.
...
```
***
The key a song is written in plays a major role in the emotional perception of a track. Minor keys are often deemed sadder or less energetic, while major keys are often described as happier or more energetic. As seen on [this tab](###more-aggressive-=-faster?), these descriptions aren't alway accurate.\
